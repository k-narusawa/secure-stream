...
data class ApiV1WebauthnRequestGetResponse(
        @JsonProperty("flowId")
        val flowId: String,
    ...
    companion object {
        fun from(flowId: FlowId, options: PublicKeyCredentialCreationOptions): ApiV1WebauthnRequestGetResponse {

            return ApiV1WebauthnRequestGetResponse(
                    flowId = flowId.value(),
                    rp = options.rp,
